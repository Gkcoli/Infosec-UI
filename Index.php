...
<head>
    ...
    <style>
        ...
        .confirm-modal-body {
            font-family: 'Poppins', sans-serif;
            font-weight: 600; /* Semibold body text */
            font-size: 16px;
    ...
    .confirm-button:hover {
        background-color: #1F3958; /* Darker teal on hover */
    }
    ...
    .away-from-work .leave-item h3, .away-from-work .leave-item p {
        text-align: left; /* Ensure text is aligned to the left */
        margin-left: 10px; /* Add margin to align text properly */
    }

    /* Refined Request Leave Section */
    .leave-request {
        background-color: #F6F4F0; /* Consistent background color */
        padding: 30px; /* Consistent padding */
        border-radius: 20px; /* Consistent border-radius */
    ...
    <script>
        ...
        function submitLeaveRequest(event) {
            ...
            if (leaveType && leaveFrom && leaveTo) {
                document.getElementById('modal-from-date').textContent = leaveFrom;
                document.getElementById('modal-to-date').textContent = leaveTo;
